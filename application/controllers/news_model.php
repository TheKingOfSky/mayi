...
class news_model extends CI_Model
{
	...
	public function get_tag_for_news( $news_id )
	{
		$this->db->where( 'news_id', $news_id );
		$result = $this->db->get( 'tags_news' )->row();
		return $result->tag_id;
	}

	public function news_isset( $news_id )
	{
		return $this->db->where( 'id', $news_id )->get( 'news' )->row();
	}
